# C# 15.0 — Roteiro MindSet

**Versão da linguagem:** 15.0  
**Contexto:** **C# 15** com **.NET 11** (SDK preview / **Visual Studio 2026 Insiders**). Funcionalidade documentada aqui em destaque: **argumentos em expressões de coleção** com **`with(...)`** (capacidade, comparers, …). Outras novidades surgem nas pré-visualizações públicas e na documentação *What's new in C#*.

Este roteiro usa o **SDK .NET atual** para exemplos. O `.csproj` usa **`LangVersion` `preview`** até o SDK suportar **`15`**; com **.NET 11**, pode fixar **`15`**. Inclui **cópia local** dos guias **14.0** e anteriores na mesma pasta. Não existe projeto MindSet **C# 6.0**; ver [csharp-7-0-overview.md](csharp-7-0-overview.md).

## Documentos C# 15.0 (ordem sugerida)

| Ordem | Tópico | Ficheiro |
|------:|--------|----------|
| 0 | Visão geral 15.0 | [csharp-15-0-overview.md](csharp-15-0-overview.md) |
| 1 | Argumentos em expressões de coleção (`with`) | [collection-expression-arguments.md](collection-expression-arguments.md) |

## Documentos C# 14.0 (ordem sugerida)

| Ordem | Tópico | Ficheiro |
|------:|--------|----------|
| 0 | Visão geral 14.0 | [csharp-14-0-overview.md](csharp-14-0-overview.md) |
| 1 | *Extension members* | [extension-members.md](extension-members.md) |
| 2 | Atribuição null-condicional | [null-conditional-assignment.md](null-conditional-assignment.md) |
| 3 | `nameof` e genéricos não ligados | [nameof-unbound-generic-types.md](nameof-unbound-generic-types.md) |
| 4 | Conversões implícitas `Span` / `ReadOnlySpan` | [span-implicit-conversions.md](span-implicit-conversions.md) |
| 5 | Modificadores em lambdas simples | [lambda-parameter-modifiers.md](lambda-parameter-modifiers.md) |
| 6 | Propriedades com `field` | [field-backed-properties.md](field-backed-properties.md) |
| 7 | Eventos e construtores parciais | [partial-events-constructors.md](partial-events-constructors.md) |
| 8 | Atribuição composta (`+=`, …) definida pelo utilizador | [user-defined-compound-assignment.md](user-defined-compound-assignment.md) |

## Documentos C# 13.0 (ordem sugerida)

| Ordem | Tópico | Ficheiro |
|------:|--------|----------|
| 0 | Visão geral 13.0 | [csharp-13-0-overview.md](csharp-13-0-overview.md) |
| 1 | `params` em coleções | [params-collections.md](params-collections.md) |
| 2 | `lock` e `System.Threading.Lock` | [lock-system-threading-lock.md](lock-system-threading-lock.md) |
| 3 | Escape `\e` (U+001B) | [escape-sequence-e.md](escape-sequence-e.md) |
| 4 | Overload / *method groups* (C# 13) | [overload-resolution-method-groups-csharp-13.md](overload-resolution-method-groups-csharp-13.md) |
| 5 | Índice `^` em inicializadores de objeto | [implicit-index-from-end-object-initializers.md](implicit-index-from-end-object-initializers.md) |
| 6 | `ref` / `unsafe` em iteradores e `async` | [ref-locals-iterators-async.md](ref-locals-iterators-async.md) |
| 7 | `ref struct` + interfaces | [ref-struct-implements-interface.md](ref-struct-implements-interface.md) |
| 8 | `ref struct` como tipo argumento | [ref-struct-type-arguments.md](ref-struct-type-arguments.md) |
| 9 | Propriedades e indexadores parciais | [partial-properties-indexers.md](partial-properties-indexers.md) |
| 10 | Prioridade de overload | [overload-resolution-priority.md](overload-resolution-priority.md) |

## Documentos C# 12.0 (ordem sugerida)

| Ordem | Tópico | Ficheiro |
|------:|--------|----------|
| 0 | Visão geral 12.0 | [csharp-12-0-overview.md](csharp-12-0-overview.md) |
| 1 | Construtores primários | [primary-constructors.md](primary-constructors.md) |
| 2 | Expressões de coleção | [collection-expressions.md](collection-expressions.md) |
| 3 | *Inline arrays* | [inline-arrays.md](inline-arrays.md) |
| 4 | Parâmetros opcionais em lambdas | [lambda-optional-parameters.md](lambda-optional-parameters.md) |
| 5 | Parâmetros `ref readonly` | [ref-readonly-parameters.md](ref-readonly-parameters.md) |
| 6 | Alias para qualquer tipo (`using`) | [alias-any-type.md](alias-any-type.md) |
| 7 | Atributo `Experimental` | [experimental-attribute.md](experimental-attribute.md) |
| 8 | *Interceptors* (pré-visualização) | [interceptors-preview.md](interceptors-preview.md) |
...
1. Leia [csharp-15-0-overview.md](csharp-15-0-overview.md) e siga a tabela **C# 15.0**; use **14.0** / **13.0** / **12.0** conforme necessário.
2. Recorra às tabelas **5.0** … **1.0** quando precisar de fundações.
3. `dotnet run --project MindSetCSharp15_0.Console`

## Ligações

- Formato: [FORMATO_DO_PROJETO.md](../../FORMATO_DO_PROJETO.md)
- Índice: [DOCUMENTATION_INDEX.md](../../DOCUMENTATION_INDEX.md)
- Edição anterior (C# 14.0): [MindSetCSharp14_0.Console/Docs/README.md](../../MindSetCSharp14_0.Console/Docs/README.md)
- Outras edições: [MindSetCSharp1_0.Console/Docs/README.md](../../MindSetCSharp1_0.Console/Docs/README.md) · [MindSetCSharp1_2.Console/Docs/README.md](../../MindSetCSharp1_2.Console/Docs/README.md) · [MindSetCSharp2_0.Console/Docs/README.md](../../MindSetCSharp2_0.Console/Docs/README.md) · [MindSetCSharp3_0.Console/Docs/README.md](../../MindSetCSharp3_0.Console/Docs/README.md) · [MindSetCSharp4_0.Console/Docs/README.md](../../MindSetCSharp4_0.Console/Docs/README.md) · [MindSetCSharp5_0.Console/Docs/README.md](../../MindSetCSharp5_0.Console/Docs/README.md) · [MindSetCSharp7_0.Console/Docs/README.md](../../MindSetCSharp7_0.Console/Docs/README.md) · [MindSetCSharp7_1.Console/Docs/README.md](../../MindSetCSharp7_1.Console/Docs/README.md) · [MindSetCSharp7_2.Console/Docs/README.md](../../MindSetCSharp7_2.Console/Docs/README.md) · [MindSetCSharp7_3.Console/Docs/README.md](../../MindSetCSharp7_3.Console/Docs/README.md) · [MindSetCSharp8_0.Console/Docs/README.md](../../MindSetCSharp8_0.Console/Docs/README.md) · [MindSetCSharp9_0.Console/Docs/README.md](../../MindSetCSharp9_0.Console/Docs/README.md) · [MindSetCSharp10_0.Console/Docs/README.md](../../MindSetCSharp10_0.Console/Docs/README.md) · [MindSetCSharp11_0.Console/Docs/README.md](../../MindSetCSharp11_0.Console/Docs/README.md) · [MindSetCSharp12_0.Console/Docs/README.md](../../MindSetCSharp12_0.Console/Docs/README.md) · [MindSetCSharp13_0.Console/Docs/README.md](../../MindSetCSharp13_0.Console/Docs/README.md) · [MindSetCSharp14_0.Console/Docs/README.md](../../MindSetCSharp14_0.Console/Docs/README.md)
