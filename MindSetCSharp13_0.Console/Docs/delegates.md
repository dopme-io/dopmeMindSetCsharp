...
> **C# 2.0:** **métodos anónimos**, conversão de **grupo de métodos** e **inferência** de tipo de delegado — ver [anonymous-methods.md](anonymous-methods.md) e [other-features-2-0.md](other-features-2-0.md).  
> **C# 3.0:** **lambdas** — [lambda-expressions.md](lambda-expressions.md); **árvores de expressão** — [expression-trees.md](expression-trees.md).
