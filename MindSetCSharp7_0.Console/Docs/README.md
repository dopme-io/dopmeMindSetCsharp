# C# 7.0 — Roteiro MindSet

**Versão da linguagem:** 7.0  
**Contexto:** **março de 2017**, com o **Visual Studio 2017**, em paralelo com **.NET Core** multiplataforma e foco em **cloud** e **portabilidade**. C# 7.0 continua a linha da **6.0**: várias funcionalidades **evolutivas** que permitem código **mais limpo** — em destaque **`out var`**, **tuplos** com **desconstrução**, **pattern matching** inicial, **funções locais**, **`ref` locals/returns**, **discards**, **literais binários** / **separadores de dígitos** e **`throw`** como expressão.

Este roteiro usa o **SDK .NET atual** para exemplos. Não existe neste repositório um projeto **MindSet C# 6.0**; o [csharp-7-0-overview.md](csharp-7-0-overview.md) assinala essa lacuna.

**Edições seguintes:** [C# 7.1](../../MindSetCSharp7_1.Console/Docs/README.md) — … · [C# 7.2](../../MindSetCSharp7_2.Console/Docs/README.md) — … · [C# 7.3](../../MindSetCSharp7_3.Console/Docs/README.md) — … · [C# 8.0](../../MindSetCSharp8_0.Console/Docs/README.md) — NRT, `switch` expr., `IAsyncEnumerable`, índices/ranges, … · [C# 9.0](../../MindSetCSharp9_0.Console/Docs/README.md) — records, top-level statements, … · [C# 10.0](../../MindSetCSharp10_0.Console/Docs/README.md) — *record structs*, .NET 6, …

## Documentos C# 7.0 (ordem sugerida)
