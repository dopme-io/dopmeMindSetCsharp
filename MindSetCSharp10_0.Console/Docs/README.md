# C# 10.0 — Roteiro MindSet

**Versão da linguagem:** 10.0  
**Contexto:** **novembro de 2021**; alinhado a **.NET 6** e à **cadência anual** de releases. Menos cerimónia (`global using`, `namespace` por ficheiro), dados estruturados (*record structs*, `with` em structs), desempenho (**interpolated string handlers**, `[AsyncMethodBuilder]`). Funcionalidades **preview** (atributos genéricos, membros estáticos abstratos em interfaces) podem mudar antes do estado final.

Este roteiro usa o **SDK .NET atual** para exemplos. Inclui **cópia local** dos guias **9.0** e anteriores na mesma pasta. Não existe projeto MindSet **C# 6.0**; ver [csharp-7-0-overview.md](csharp-7-0-overview.md).
...
1. Leia [csharp-10-0-overview.md](csharp-10-0-overview.md) e siga a tabela **C# 10.0**; use **9.0** / **8.0** conforme necessário.
2. Recorra às tabelas **5.0** … **1.0** quando precisar de fundações.
3. `dotnet run --project MindSetCSharp10_0.Console`

## Ligações

- Formato: [FORMATO_DO_PROJETO.md](../../FORMATO_DO_PROJETO.md)
- Índice: [DOCUMENTATION_INDEX.md](../../DOCUMENTATION_INDEX.md)
- Edição anterior (C# 9.0): [MindSetCSharp9_0.Console/Docs/README.md](../../MindSetCSharp9_0.Console/Docs/README.md)
- Edição seguinte (C# 11.0): [MindSetCSharp11_0.Console/Docs/README.md](../../MindSetCSharp11_0.Console/Docs/README.md)
