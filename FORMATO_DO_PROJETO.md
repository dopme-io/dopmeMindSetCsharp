...
|----------|-----------|
| `Program.cs` | Entrada; aponta para `Docs/` |
| `Docs/` | Cópia dos guias **10.0**/… + guias **11.0** (*raw strings*, matemática genérica, UTF-8 `u8`, *list patterns*, tipos `file`, `required`, `ref fields` / `scoped`, …) — [csharp-11-0-overview.md](MindSetCSharp11_0.Console/Docs/csharp-11-0-overview.md); **`LangVersion` 11** no `.csproj`; **novembro 2022** / **.NET 7** |
...
|----------|-----------|
| `Program.cs` | Entrada; aponta para `Docs/` |
| `Docs/` | Cópia dos guias **11.0**/… + guias **12.0** (construtores primários, expressões de coleção, *inline arrays*, parâmetros opcionais em lambdas, `ref readonly`, alias `using` para qualquer tipo, `Experimental`, *interceptors* em pré-visualização, …) — [csharp-12-0-overview.md](MindSetCSharp12_0.Console/Docs/csharp-12-0-overview.md); **`LangVersion` 12** no `.csproj`; **novembro 2023** / **.NET 8** |
...
|----------|-----------|
| `Program.cs` | Entrada; aponta para `Docs/` |
| `Docs/` | Cópia dos guias **12.0**/… + guias **13.0** (`params` em coleções, `System.Threading.Lock`, escape `\e`, `ref struct` + interfaces e genéricos, partial properties/indexers, prioridade de overload, …) — [csharp-13-0-overview.md](MindSetCSharp13_0.Console/Docs/csharp-13-0-overview.md); **`LangVersion` 13** no `.csproj`; **novembro 2024** / **.NET 9** |
...
|----------|-----------|
| `Program.cs` | Entrada; aponta para `Docs/` |
| `Docs/` | Cópia dos guias **13.0**/… + guias **14.0** (*extension members*, atribuição null-condicional, `nameof` com genéricos não ligados, conversões implícitas `Span`/`ReadOnlySpan`, modificadores em lambdas, propriedades com `field`, partial events/constructors, operadores `+=`/compostos, …) — [csharp-14-0-overview.md](MindSetCSharp14_0.Console/Docs/csharp-14-0-overview.md); **`LangVersion` 14** no `.csproj`; **novembro 2025** / **.NET 10** |
...
|----------|-----------|
| `Program.cs` | Entrada; aponta para `Docs/` |
| `Docs/` | Cópia dos guias **14.0**/… + guias **15.0** (argumentos `with(...)` em expressões de coleção; notas sobre **.NET 11** preview / VS 2026 Insiders) — [csharp-15-0-overview.md](MindSetCSharp15_0.Console/Docs/csharp-15-0-overview.md); **`LangVersion` `preview`** (ou **`15`** com SDK .NET 11) no `.csproj` |
...
Crie outro projeto console (ex.: `MindSetCSharp16_0.Console`), adicione à solução, crie `Docs/` no mesmo padrão e atualize este ficheiro e o [README.md](README.md).
...
- C# 11.0: [MindSetCSharp11_0.Console/Docs/README.md](MindSetCSharp11_0.Console/Docs/README.md)
- C# 12.0: [MindSetCSharp12_0.Console/Docs/README.md](MindSetCSharp12_0.Console/Docs/README.md)
- C# 13.0: [MindSetCSharp13_0.Console/Docs/README.md](MindSetCSharp13_0.Console/Docs/README.md)
- C# 14.0: [MindSetCSharp14_0.Console/Docs/README.md](MindSetCSharp14_0.Console/Docs/README.md)
- C# 15.0: [MindSetCSharp15_0.Console/Docs/README.md](MindSetCSharp15_0.Console/Docs/README.md)
