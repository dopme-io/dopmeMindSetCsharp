# C# 7.2 — Roteiro MindSet

**Versão da linguagem:** 7.2  
**Contexto:** **novembro de 2017**, **Visual Studio 2017**; melhorias **incrementais** em **`ref`/`in`**, **`readonly struct`** / **`ref struct`**, **`stackalloc`**, **`fixed`**, argumentos nomeados, literais numéricos, **`private protected`**, e expressão condicional **`ref`**.

Este roteiro usa o **SDK .NET atual** para exemplos. Inclui **cópia local** dos guias **7.1**, **7.0** e anteriores na mesma pasta. Não existe projeto MindSet **C# 6.0**; ver [csharp-7-0-overview.md](csharp-7-0-overview.md).

**Edições seguintes:** [C# 7.3](../../MindSetCSharp7_3.Console/Docs/README.md) — … · [C# 8.0](../../MindSetCSharp8_0.Console/Docs/README.md) — NRT, default interface members, `switch` expressions, … · [C# 9.0](../../MindSetCSharp9_0.Console/Docs/README.md) — records, top-level statements, .NET 5, … · [C# 10.0](../../MindSetCSharp10_0.Console/Docs/README.md) — *record structs*, .NET 6, …

## Documentos C# 7.2 (ordem sugerida)
...
1. Leia [csharp-7-2-overview.md](csharp-7-2-overview.md) e siga a tabela **C# 7.2**; use **7.1** e **7.0** conforme necessário.
2. Recorra às tabelas **5.0** … **1.0** quando precisar de fundações.
3. `dotnet run --project MindSetCSharp7_2.Console`

## Ligações

- Formato: [FORMATO_DO_PROJETO.md](../../FORMATO_DO_PROJETO.md)
- Índice: [DOCUMENTATION_INDEX.md](../../DOCUMENTATION_INDEX.md)
- Edição seguinte: [MindSetCSharp7_3.Console/Docs/README.md](../../MindSetCSharp7_3.Console/Docs/README.md) · [MindSetCSharp8_0.Console/Docs/README.md](../../MindSetCSharp8_0.Console/Docs/README.md) · [MindSetCSharp9_0.Console/Docs/README.md](../../MindSetCSharp9_0.Console/Docs/README.md) · [MindSetCSharp10_0.Console/Docs/README.md](../../MindSetCSharp10_0.Console/Docs/README.md)
- Edição anterior (C# 7.1): [MindSetCSharp7_1.Console/Docs/README.md](../../MindSetCSharp7_1.Console/Docs/README.md)
- Outras edições: [MindSetCSharp1_0.Console/Docs/README.md](../../MindSetCSharp1_0.Console/Docs/README.md) · [MindSetCSharp1_2.Console/Docs/README.md](../../MindSetCSharp1_2.Console/Docs/README.md) · [MindSetCSharp2_0.Console/Docs/README.md](../../MindSetCSharp2_0.Console/Docs/README.md) · [MindSetCSharp3_0.Console/Docs/README.md](../../MindSetCSharp3_0.Console/Docs/README.md) · [MindSetCSharp4_0.Console/Docs/README.md](../../MindSetCSharp4_0.Console/Docs/README.md) · [MindSetCSharp5_0.Console/Docs/README.md](../../MindSetCSharp5_0.Console/Docs/README.md) · [MindSetCSharp7_0.Console/Docs/README.md](../../MindSetCSharp7_0.Console/Docs/README.md)
