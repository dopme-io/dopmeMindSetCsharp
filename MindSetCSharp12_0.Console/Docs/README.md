# C# 12.0 — Roteiro MindSet

**Versão da linguagem:** 12.0  
**Contexto:** **novembro de 2023**; alinhado a **.NET 8** e à **cadência anual** de releases. Construtores primários em `class`/`struct`, expressões de coleção com *spread* (`..`), *inline arrays*, parâmetros opcionais em lambdas, `ref readonly`, alias `using` para qualquer tipo, atributo `Experimental`, e *interceptors* em pré-visualização.

Este roteiro usa o **SDK .NET atual** para exemplos. O `.csproj` fixa **`LangVersion` 12**. Inclui **cópia local** dos guias **11.0** e anteriores na mesma pasta. Não existe projeto MindSet **C# 6.0**; ver [csharp-7-0-overview.md](csharp-7-0-overview.md).
...
1. Leia [csharp-12-0-overview.md](csharp-12-0-overview.md) e siga a tabela **C# 12.0**; use **11.0** / **10.0** / **9.0** conforme necessário.
2. Recorra às tabelas **5.0** … **1.0** quando precisar de fundações.
3. `dotnet run --project MindSetCSharp12_0.Console`

## Ligações

- Formato: [FORMATO_DO_PROJETO.md](../../FORMATO_DO_PROJETO.md)
- Índice: [DOCUMENTATION_INDEX.md](../../DOCUMENTATION_INDEX.md)
- Edição anterior (C# 11.0): [MindSetCSharp11_0.Console/Docs/README.md](../../MindSetCSharp11_0.Console/Docs/README.md)
